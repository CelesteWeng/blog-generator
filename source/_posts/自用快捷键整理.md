...
playlist: 
  -
    name: TUI
    artist: FKJ
    url: "//music.163.com/song/media/outer/url?id=535453970.mp3"
    cover: "//p2.music.126.net/rWbJ6dbIX3KOLe-n3yNOhA==/109951163132365105.jpg?param=130y130"
---

// 慢慢整吧，表示只想试试音乐？ Higher Brothers 好棒啊啊啊啊
...
2. 移动光标（在原有按键上加上 ⇧ 则同时选中）：
   - 以单词为单位移动：alt + ← / →
   - 移动到行首/行尾：⌘ + ← / →
   - 文档开始/结束：⌘ + ↑ / ↓ （webStorm 中默认是修改焦点的，自己改下）
...
8. 删除当前行 / 删除选中的多行：⌘⌫
9. F你懂的：⇧⌘F
10. webStorm 中，`consolo.log(xxx)`，输入 `xxx.log` + Tab 即可
...
1. [美化表单的CSS高级技巧](https://www.w3cplus.com/css/advanced-css-form-styling.html)
2. [大公司里怎样开发和部署前端代码？](https://www.zhihu.com/question/20790576)
3. [毫秒必争，前端网页性能最佳实践](http://www.cnblogs.com/cookiehu/p/5069900.html)
4. [mobile-device-js](https://github.com/joyqi/mobile-device-js/blob/master/device.js)（万一用得上呢）
5. [65个免费下载的HTML5+CSS3登陆表单](https://www.ui.cn/detail/70262.html)
6. [Safari 前端开发调试 iOS 完美解决方案（iPhone/iTouch 等）](https://chon.io/blog/safari-ios-iphone-itouch-web-dev-inspector/)（电脑改代码，手机看效果）
7. [思路清奇：通过 JavaScript 获取移动设备的型号](https://segmentfault.com/a/1190000010157682)
8. [在线工具导航](http://tool.oschina.net/)
9. [快速启动神器 Wox](https://www.cnblogs.com/zhaoqingqing/p/6902113.html)
10. [我不知道你知不知道的伪元素实用小技巧](https://zhuanlan.zhihu.com/p/31256701)
11. [如何优雅地使用Mac](https://www.jianshu.com/u/c9f16aaefd6c)
12. [前端chrome浏览器调试总结](https://www.jianshu.com/p/b25c5b88baf5)
13. [你所不知道的 CSS 滤镜技巧与细节](http://www.cnblogs.com/coco1s/p/7519460.html)
14. [JavaScript This 的六道坎](https://blog.crimx.com/2016/05/12/understanding-this/)
15. [几种 JavaScript 动画库推荐](https://zhuanlan.zhihu.com/p/28645609)
16. [typingclub](https://www.typingclub.com/sportal/program-3.game)（练指法挺好的）

## Books

链接: https://pan.baidu.com/s/13ROcS7YoD7xUoRaH57Ir4g 提取码: iqbe

## Others

再推荐一个chrome的扩展程序吧，看到好的文章想收藏时，可以添加到收藏夹，但是网址有可能会失效。这时候可以选择保存网页剪报。

1. [印象笔记](https://chrome.google.com/webstore/detail/evernote-web-clipper/pioclpoplcdbaefihamjohnefbikjilc?hl=zh-CN)
2. [有道云笔记](https://chrome.google.com/webstore/detail/%E6%9C%89%E9%81%93%E4%BA%91%E7%AC%94%E8%AE%B0%E7%BD%91%E9%A1%B5%E5%89%AA%E6%8A%A5/joinpgckiioeklibflapokicmndlcnef?hl=zh-CN)
